...
10. [词库文档格式](#词库文档格式)
11. [外挂词库](#外挂词库)
12. [搜狗词库转换方法](https://github.com/maomiui/sogou-dict-transform)
13. [Emoji](#修改-emoji)
14. [载入词库和 Emoji](#载入词库和-Emoji)
15. [自定义快捷字符](#自定义快捷字符)
16. [模糊音](#模糊音)
17. [智能纠错](#智能纠错)
...
> 注：①修改任何配置文件需重新部署方可生效；②本配置词库较大，第一次部署时间会稍长。
