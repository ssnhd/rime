...
* 修复朙月拼音和朙月拼音简化字开启模糊音无法使用超级简拼

#### 2021-05-04

* 增加 macOS 11.3 Emoji
* 升级搜狗词库：由 150 万升级至约 172 万
...
12. [词库文档格式](#词库文档格式)
13. [外挂词库](#外挂词库)
14. [搜狗词库转换方法](https://github.com/maomiui/sogou-dict-transform)
15. [Emoji](#修改-emoji)
16. [载入词库和 Emoji](#载入词库和-Emoji)
17. [自定义快捷字符](#自定义快捷字符)
18. [模糊音](#模糊音)
19. [智能纠错](#智能纠错)
20. [动态时间｜日期｜星期](#动态时间日期星期)
21. [自定义短语](#自定义短语)
22. [皮肤](#皮肤)
23. [关闭 Emoji](#关闭-emoji)
24. [特定程序里关闭开启中文输入](#特定程序里关闭开启中文输入)
25. [特定程序里中文输入英文标点](#特定程序里中文输入英文标点)
26. [删除误上屏的错词](#删除误上屏的错词)
27. [大写数字](#大写数字)
28. [同步](#同步)
29. [报错日志](#报错日志)
30. [卸载](#卸载鼠须管)
