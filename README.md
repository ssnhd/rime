...
10. [词库文档格式](#词库文档格式)
11. [外挂词库](#外挂词库)
12. [词库转换方法](https://github.com/maomiui/sogou-dict-transform)
13. [Emoji](#修改-emoji)
...
17. [自定义短语](#自定义短语)
18. [皮肤](#皮肤)
19. [关闭 Emoji](#关闭-emoji)
20. [特定程序里关闭开启中文输入](#特定程序里关闭开启中文输入)
21. [特定程序里中文输入英文标点](#特定程序里中文输入英文标点)
22. [删除误上屏的错词](#删除误上屏的错词)
23. [智能纠错](#智能纠错)
24. [动态时间｜日期｜星期](#动态时间日期星期)
25. [大写数字](#大写数字)
26. [同步](#同步)
27. [报错日志](#报错日志)
28. [卸载](#卸载鼠须管)
...
打开输入方案文件，找到 `tips: all`，开启和关闭 Emoji 注释。
