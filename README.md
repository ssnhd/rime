...
**缺点**：上手难度大、无云输入、**前期**词库/词频准确度低、维护（例如 Apple 更新 Emoji 需手动添加）。

> 很多人没坚持使用下去绝大部分是词库不支持云输入，这一点会随着输入时间积累越来越完善。
...
本配置搜狗词库将12个分类放在一起，如想单独**分类**和**搜狗词库转换方法**的请点击[这里](https://github.com/liuour/rime-dict)。
